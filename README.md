...
This repository includes the code and data for the paper "**A Framework for Remaining Useful Life Prediction Based on Self-Attention and Physics-Informed Neural Networks**"
# Abstract
